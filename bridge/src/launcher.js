...
const ACP_BACKENDS = ["codex", "claude", "omp", "pi", "gemini", "kiro", "hermes", "dsh"]
...
export function resolveBackend(args, detected = detectBackends()) {
  ...
  throw new Error("No supported agent CLI was found on PATH. Install/select omp, pi, claude, codex, gemini, kiro, hermes, dsh, or opencode, then re-run with --backend if needed.")
}
